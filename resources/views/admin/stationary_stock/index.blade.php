...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Stationay_Stock</a></li>
    <li class="breadcrumb-item active" aria-current="page">Stationay_Stock </li>
  </ol>
</nav>
...
<div class="row">
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Stationay Stock </h6>
          ...
          <table id="dataTableExample" class="table">
           ...
           @foreach($stat as $key=> $sta)
              ...
              <td>{{ ++$key }}</td>
               ...
               <td>{{ $sta->qty }}</td>
               <td>{{ ($sta->status == 0) ? 'Available' : 'Not Available' }}</td>
               {{-- <td>
                @if($sta->status == 0)
